...
##### 隠れ層 1層 [512ニューロン] - v027（円環構造 + 最適パラメータ確定版）:
  ...
  - コマンド
```python
python columnar_ed_ann_v027.py --use_circular --train 3000 --test 1000 --epochs 30 --hidden 512 --lr 0.20 --u1 0.5 --lateral_lr 0.08 --base_column_radius 0.4 --participation_rate 0.1 --seed 42
```
