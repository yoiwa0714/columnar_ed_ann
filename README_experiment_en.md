[日本語](README_experiment.md) | **English**

# **[Columnar ED Method] Experiment Version — Extension of the Original ED Method with Cortical Column Structure**
...
|----------------|------|---------|
| **Experiment Version** | `columnar_ed_ann_experiment.py` | All parameters configurable. This document covers this version. |
| Main Version | `columnar_ed_ann.py` | High accuracy with minimal arguments. See [README_en.md](README_en.md). |

> **Key differences from the Main Version:**
> - Gabor feature extraction is OFF by default; enable explicitly with `--gabor_features` (Main Version has it ON by default)
...
- Learning core: `modules_experiment/ed_network.py`
- Activations and related helpers: `modules_experiment/activation_functions.py`
...
> In the Experiment Version, detailed filter parameters can be adjusted via `--gabor_orientations`, `--gabor_frequencies`, `--gabor_kernel_size`, `--gabor_pool_size`, `--gabor_pool_stride`, and `--gabor_no_edge`.
...
```
columnar_ed_ann/
├── columnar_ed_ann.py              # Main Version script (recommended)
├── columnar_ed_ann_experiment.py   # ★ Experiment Version main script (this document)
├── README.md                       # Main Version documentation (Japanese)
├── README_en.md                    # Main Version documentation (English)
├── README_experiment.md            # ★ This document (Experiment Version, Japanese)
├── README_experiment_en.md         # This document (Experiment Version, English)
├── LICENSE                         # License
...
│
├── modules_experiment/              # ★ Experiment Version modules (this document)
...
Even in the Experiment Version, optimal parameters are automatically loaded from `config/hyperparameters.yaml` based on the number of hidden layers. Values explicitly specified via command-line arguments take precedence over automatic settings.
...
3. **View settings**: `python columnar_ed_ann_experiment.py --list_hyperparams`
